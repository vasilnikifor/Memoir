...
public extension NSLayoutAnchor {
    @objc
    @discardableResult
    func constraint(relation: NSLayoutConstraint.Relation,
...
public extension NSLayoutDimension {
    ...
    func constraint(relation: NSLayoutConstraint.Relation,
                    ...
                    constant: CGFloat) -> NSLayoutConstraint {
        switch relation {
        case .equal: return constraint(equalTo: dimension, multiplier: multiplier, constant: constant)
        case .lessThanOrEqual: return constraint(lessThanOrEqualTo: dimension, multiplier: multiplier, constant: constant)
        case .greaterThanOrEqual: return constraint(greaterThanOrEqualTo: dimension, multiplier: multiplier, constant: constant)
        @unknown default: fatalError("This constraint does not have this relation.")
        }
    }
